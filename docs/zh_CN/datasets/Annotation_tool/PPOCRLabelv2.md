...
|                      常规标注                       |                    表格标注                    |
| :-------------------------------------------------: | :--------------------------------------------: |
|  <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/PPOCRLabel/data/gif/steps_en.gif" width="80%"/>   | <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/PPOCRLabel/data/gif/table.gif" width="100%"/> |
|                 **不规则文本标注**                  | 
| <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/PPOCRLabel/data/gif/multi-point.gif" width="80%"/> |  
