...
### 一、工具简介
<div align="center">
    <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/doc/images/3.png" width="800">
</div>
...
<div align="center">
    <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/doc/images/2.png" width="1000">
</div>
...
<div align="center">
    <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/examples/style_images/2.jpg" width="300">
</div>

生成合成数据`fake_fusion.jpg`：
<div align="center">
    <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/doc/images/4.jpg" width="300">
</div>

除此之外，程序还会生成并保存中间结果`fake_bg.jpg`：为风格参考图去掉文字后的背景；

<div align="center">
    <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/doc/images/7.jpg" width="300">
</div>

`fake_text.jpg`：是用提供的字符串，仿照风格参考图中文字的风格，生成在灰色背景上的文字图片。

<div align="center">
    <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/doc/images/8.jpg" width="300">
</div>
...
<div align="center">
    <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/doc/images/5.png" width="800">
</div>
...
2. 运行`tools/synth_dataset`合成数据：
   ...
   我们在examples目录下提供了样例图片和语料。
    <div align="center">
        <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/examples/style_images/1.jpg" width="300">
        <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/examples/style_images/2.jpg" width="300">
    </div>

   直接运行上述命令，可以在output_data中产生样例输出，包括图片和用于训练识别模型的标注文件：
   <div align="center">
       <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/doc/images/12.png" width="800">
   </div>
...
<div align="center">
    <img src="https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.6/StyleText/doc/images/6.png" width="800">
</div>
